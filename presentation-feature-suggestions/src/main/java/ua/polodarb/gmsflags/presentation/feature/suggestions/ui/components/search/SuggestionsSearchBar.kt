package ua.polodarb.gmsflags.presentation.feature.suggestions.ui.components.search
...
@Composable
internal fun SuggestionsSearchBar(
    query: String,
    ...
    Box(
        ...
        GmsSearchField(
            ...
            placeholder = stringResource(R.string.suggestions_search_placeholder),
            requestFocus = true,
            modifier = Modifier
                .fillMaxWidth()
