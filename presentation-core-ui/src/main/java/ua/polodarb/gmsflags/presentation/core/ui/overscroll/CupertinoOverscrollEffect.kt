...
class CupertinoOverscrollEffect(
    ...
    private val rubberBandCoefficient: Float = DEFAULT_RUBBER_BAND_COEFFICIENT,
    ...
    private var overscrollOffset: Offset
        ...
        set(value) {
            overscrollOffsetState.value =
                if (!topOverscrollEnabled && value.y > 0f) Offset(value.x, 0f) else value
    ...
    private fun Offset.rubberBanded(): Offset {
        ...
        return Offset(
            rubberBandedValue(dpOffset.x, dpSize.width, rubberBandCoefficient),
            rubberBandedValue(dpOffset.y, dpSize.height, rubberBandCoefficient)
        ) * density
    }
    ...
    companion object Companion {
        const val DEFAULT_RUBBER_BAND_COEFFICIENT = 0.55f
    }
}
...
private class CupertinoOverscrollNode(
    ...
    override fun onPointerEvent(
        ...
        if (pass == PointerEventPass.Initial) {
            ...
            if (pointersDown < 0) pointersDown = 0
        }
    }
